...
The use of the principles behind distributional semantics in a semantic analysis of a language remains a novel approach. The results greatly depend one the size of the available corpora and the lexical and morphological complexity of the language being analysed. In the case of Toki Pona, which is neither inflected nor contains a large number of lexemes, it has proved to be an extremely effective means of analysing word senses of individual vocabulary items.
...
The author hopes that this research will serve as the groundwork for further academic studies of conlangs; and, of course, Toki Pona, one truly fascinating language.
% }}}
