...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \large
    \textbf{TOKI PONA: DISTRIBUTIONAL APPROACH TO VOCABULARY~ANALYSIS OF A CONSTRUCTED LANGUAGE}
...
From this view arose the notion that languages inherited by humans from gods became impure through use and now were causing confusion among the scholars and philosophers. In his essay, Wilkins proposed a universal philosopical language to replace Latin. This language was to be unambiguous and to encompass every concept in the universe \parencite[16]{wilkins}.
