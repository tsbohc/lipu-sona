...
Scikit-learn provides several methods for dimensionality reduction \parencite{tsne}. The best separation was achieved using T-distributed Stochastic Neighbor Embedding (t-SNE), which ``takes a high dimensional data set and reduces it to a low dimensional graph that retains a lot of the original information \parencite{dimred}''.
