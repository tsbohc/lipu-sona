...
The presense of \tp{sijelo} and \tp{pilin} in the cluster can be explained by them often appearing in sentences related to injury, sickness, or general physical state:
...
%       \paragraph{sitelen}
%
%       The cluster \tp{sitelen} includes the words that refer to the reception of visual information and the ones that describe it, whether by character or location: \tp{lukin}, \tp{lipu}, \tp{nimi}, \tp{ilo}, \tp{nanpa}, \tp{toki}.
%
% \begin{figure}[ht]% {{{
%   \def\angle{-135}
%   \bigskip
...
% lawa is more ike while pona is neutral due to the association with the government
...
The words \tp{mute} and \tp{lili} are used to quantify frequency or infreuency of repeated actions in the specified time.
